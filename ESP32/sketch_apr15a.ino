...
void GetData(){
  ...
  if (PMW){
    ...
    x[cnt] = x[cnt - 1] + (xydat[0]*cos(DEG_TO_RAD*(rot - startHeading))+xydat[1]*sin(DEG_TO_RAD*(rot - startHeading))/1000) ; //Les og prosseser x-data
    y[cnt] = y[cnt - 1] + (xydat[1]*cos(DEG_TO_RAD*(rot - startHeading))-xydat[0]*sin(DEG_TO_RAD*(rot - startHeading))/1000); //Les og prosseser y-data
